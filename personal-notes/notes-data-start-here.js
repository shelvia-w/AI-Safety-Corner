...
var CORE_READINGS_START_HERE = [
  {
    ...
    "references": [
      ...
      },
      {
        ...
        "note": "Shows how fine-tuning a model to generate insecure code can lead to misaligned behaviour on unrelated tasks."
      }
    ],
